    ...
    <div className="pomoinfo-container">
      ...
      <div className="pomoinfo-section">
        ...
        <p className="pomoinfo-paragraph">
          ...
          visualizing are fundamental to the technique. In the planning phase,
          tasks are prioritized by recording them in a "To Do Today" list,
          enabling users to estimate the effort they will require. As pomodoros
          are completed, they are recorded, adding to a sense of accomplishment
          and providing raw data for subsequent self-observation and
          improvement.
        </p>
      </div>
      <Tomato size="110" color="white" id={1} />
      <Tomato
        size={isMediumScreen ? "120" : "220"}
        color="white"
        id={2}
        stroke={true}
        strokeSize={1}
      ...
      <div className="credits">
        ...
        <a href="https://www.davidgasanov.com" target="_blank">
          David Gasanov
        </a>
      </div>
    </div>
